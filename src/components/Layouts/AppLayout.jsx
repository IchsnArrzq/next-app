            ...
            <Group position="right">
              <ActionIcon>
                <ChevronsLeft
                  style={{
                    transform:
                      navbar == 250 ? 'rotate(0deg)' : 'rotate(180deg)',
                  }}
                  onClick={() =>
                    navbar == 250 ? setNavbar(100) : setNavbar(250)
                  }
                />
              </ActionIcon>
            </Group>
            ...
            <Accordion disableIconRotation iconPosition="right" multiple>
              <Accordion.Item
                ...
                <Group>
                  ...
                  <UnstyledButton
                    style={{ width: '100%' }}
                    onClick={() => router.push('/master/permission')}>
                    {navbar == 250 ? (
                      <Group position="apart">
                        <Title order={6}>permission</Title>
                        <ThemeIcon color="violet" variant="light">
                          <License size={14} />
                        </ThemeIcon>
                      </Group>
                  ...
                  <UnstyledButton
                    style={{ width: '100%' }}
                    onClick={() => router.push('/master/shift')}>
                    {navbar == 250 ? (
                      <Group position="apart">
                        <Title order={6}>shift</Title>
                        <ThemeIcon color="violet" variant="light">
                          <Clock size={14} />
                        </ThemeIcon>
                      </Group>
                  ...
                  <UnstyledButton
                    style={{ width: '100%' }}
                    onClick={() => router.push('/master/department')}>
                    {navbar == 250 ? (
                      <Group position="apart">
                        <Title order={6}>department</Title>
                        <ThemeIcon color="violet" variant="light">
                          <Building size={14} />
                        </ThemeIcon>
                      </Group>
                  ...
                  <UnstyledButton
                    style={{ width: '100%' }}
                    onClick={() => router.push('/master/category-machine')}>
                    {navbar == 250 ? (
                      <Group position="apart">
                        <Title order={6}>category machine</Title>
                        <ThemeIcon color="violet" variant="light">
                          <Engine size={14} />
                        </ThemeIcon>
                      </Group>
                  ...
                  <UnstyledButton
                    style={{ width: '100%' }}
                    onClick={() => router.push('/master/process-production')}>
                    {navbar == 250 ? (
                      <Group position="apart">
                        <Title order={6}>process production</Title>
                        <ThemeIcon color="violet" variant="light">
                          <Subtask size={14} />
                        </ThemeIcon>
                      </Group>
              ...
              <Accordion.Item
                ...
                <Group>
                  <UnstyledButton
                    style={{ width: '100%' }}
                    onClick={() => router.push('/activity/machine')}>
                    {navbar == 250 ? (
                      <Group position="apart">
                        <Title order={6}>Machine Monitor</Title>
                        <ThemeIcon color="violet" variant="light">
                  ...
                  <UnstyledButton
                    ...
                    {navbar == 250 ? (
                      <Group position="apart">
                        <Title order={6}>Planning Machine</Title>
                        <ThemeIcon color="violet" variant="light">
