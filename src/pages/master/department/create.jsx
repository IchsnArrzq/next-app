...
export default function DepartmentCreate() {
    ...
    const Submit = async () => {
        setVisible(true)
        try {
            const { data } = await axios.post('/api/department', form.values)
            showNotification({
            ...
            <Card p='xl' shadow="sm">
                <Card.Section p='md'>
                    <Group position='apart'>
                        ...
                        <Title order={5}>Create new Department</Title>
                    </Group>
                </Card.Section>
...
DepartmentCreate.getLayout = page => <AppLayout children={page} />
