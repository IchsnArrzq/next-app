...
export default function ProcessProductionIndex({ departments, context, errors }) {
    ...
    const Delete = async id => {
        ...
        try {
            ...
            router.push('/master/process-production')
        } catch (error) {
            showNotification({
            ...
            <Card px='xl' py='xl' shadow="sm">
                <Card.Section p="md">
                    <Group position='apart'>
                        ...
                        <Button variant='filled' onClick={() => router.push('/master/process-production/create')}>
                            create
                        </Button>
                    </Group>
                </Card.Section>
...
export async function getServerSideProps(context) {
    try {
        const { data } = await axios.get('/api/process-production', {
            headers: {
