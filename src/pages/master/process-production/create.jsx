...
export default function ProcessProductionCreate() {
    ...
    const Submit = async () => {
        setVisible(true)
        try {
            const { data } = await axios.post('/api/process-production', form.values)
            showNotification({
            ...
            <Card p='xl' shadow="sm">
                <Card.Section p='md'>
                    <Group position='apart'>
                        ...
                        <Title order={5}>Create new Process Production</Title>
                    </Group>
                </Card.Section>
...
ProcessProductionCreate.getLayout = page => <AppLayout children={page} />
