...
export default function CategoryMachineCreate() {
    ...
    const Submit = async () => {
        setVisible(true)
        try {
            const { data } = await axios.post('/api/category-machine', form.values)
            showNotification({
            ...
            <Card p='xl' shadow="sm">
                <Card.Section p='md'>
                    <Group position='apart'>
                        ...
                        <Title order={5}>Create new category-machine</Title>
                    </Group>
                </Card.Section>
...
CategoryMachineCreate.getLayout = page => <AppLayout children={page} />
